...
const listprofesor = async () => {
  try {
    const response = await fetch("../../ADMINISTRADOR/AGREGAR_ADMINISTRADOR/obtener_datos.php");
    ...
    (async () => {
      const { value: formValues } = await Swal.fire({
        ...
        preConfirm: () => {
          ...
          return { nombre: nombre, paterno: paterno, materno: materno, correo: correo, password: password };
        },
      });
