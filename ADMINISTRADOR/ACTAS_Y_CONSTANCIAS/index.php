...
<body>
        ...
        <div class="contenedor">
            <nav class="contenedor menu">
                <ul class="menu-lista">
                    ...
                    <li class="opcion disabled"><a href="../ACTAS_Y_CONSTANCIAS/"><i class="fa-solid fa-file"></i> ACTAS Y CONSTANCIAS</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <main>
        <div class="container my-5 table-responsive" id="contenedor_tabla">
            <div class="row">
                <table id="actas" class="table table-striped">
                    <thead>
                        <tr>
    ...
    <script src="../../JS/ADMINISTRADOR/constancias.js"></script>
</body>
