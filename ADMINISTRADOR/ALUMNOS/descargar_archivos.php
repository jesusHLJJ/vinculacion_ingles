...
if ($id_expediente_result->num_rows > 0) {
    ...
    // Consulta para obtener las rutas de los archivos a partir del id_expediente
    $expediente_query = "SELECT lin_captura, soli_aspirante, act_nac, comp_estu, ine, comp_pago FROM expediente WHERE id_expediente = '$id_expediente'";
    ...
    if ($expediente_result->num_rows > 0) {
        ...
        $files = [
            ...
            'soli_aspirante' => $expediente_row['soli_aspirante'],
            'act_nac' => $expediente_row['act_nac'],
            'comp_estu' => $expediente_row['comp_estu'],
            'ine' => $expediente_row['ine'],
